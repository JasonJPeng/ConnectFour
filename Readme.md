...
Connect Four game. Since state based logic is simpler to test, the candidate is
expected to heavily rely on testing. The candidate is also expected to provide
a documentation describing how to run the solution submitted.
